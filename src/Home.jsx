...
function HomePageContent() {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative flex flex-col items-center justify-center min-h-[80vh] bg-cover bg-no-repeat w-screen text-white text-center" style={{backgroundImage: "url('/src/assets/images/backgroundpic.jpg')"}}>
